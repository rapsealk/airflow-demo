...
MNIST_DATASET_PATH = Path("/pipeline/input1") / os.getenv("MNIST_DATASET_PATH", "")
CHECKPOINT_PATH = Path("/pipeline/vfroot") / os.getenv("BACKENDAI_PIPELINE_JOB_ID") / "mnist_cnn.ckpt"
